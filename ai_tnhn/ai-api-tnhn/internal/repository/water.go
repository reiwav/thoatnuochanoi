...
type Rain interface {
	GetByStationID(ctx context.Context, stationID int64, limit int64) ([]*models.RainRecord, error)
...
type Lake interface {
	GetByStationID(ctx context.Context, stationID int64, limit int64) ([]*models.LakeRecord, error)
...
type River interface {
	GetByStationID(ctx context.Context, stationID int64, limit int64) ([]*models.RiverRecord, error)
