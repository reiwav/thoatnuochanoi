...
func (s *service) GetInundationSummaryByDate(ctx context.Context, orgID string, isAllowedAll bool, assignedInuIDs []string, dateStr string) (*inundation.InundationSummaryData, error) {
