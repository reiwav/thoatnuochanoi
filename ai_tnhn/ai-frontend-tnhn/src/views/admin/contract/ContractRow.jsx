...
import { 
    IconTrash, IconEdit, IconFileText, IconChevronDown, IconChevronUp, IconCash
} from '@tabler/icons-react';
import dayjs from 'dayjs';
import PermissionGuard from 'ui-component/PermissionGuard';

const ContractRow = ({ row, handleOpenEdit, handleDelete, isMobile, formatPrice, getTotalPrice, hasPermission }) => {
