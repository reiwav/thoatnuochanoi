...
const EmployeeList = () => {
    ...
    const canSelectOrg = ['super_admin', 'supper_admin', 'supper_admib', 'chu_tich_cty', 'giam_doc_cty', 'pho_giam_doc_cty', 'phong_ht_mt_cds', 'giam_doc_xn', 'giam_doc_xi_nghiep'].includes(userRole);
