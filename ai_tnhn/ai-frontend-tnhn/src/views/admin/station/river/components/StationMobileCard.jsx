        ...
        <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
            <Stack spacing={1.5}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                        <Typography variant="caption" color="text.secondary" sx={{ fontWeight: 600, display: 'block', mb: 0.5 }}>ĐỊA CHỈ</Typography>
                        <Typography variant="body2" sx={{ fontWeight: 700 }}>{row.DiaChi || '-'}</Typography>
                    </Grid>
                </Grid>
