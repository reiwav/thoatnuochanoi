        ...
        <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
            <Stack spacing={1.5}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Typography variant="caption" color="text.secondary" sx={{ fontWeight: 600 }}>ĐƠN VỊ QUẢN LÝ</Typography>
                ...
                <Typography variant="body2" sx={{ fontWeight: 700, color: 'secondary.main', mt: -1 }}>{organizationName || '-'}</Typography>
                ...
                <Grid container spacing={1.5} sx={{ bgcolor: 'action.hover', p: 1.5, borderRadius: '8px' }}>
                    ...
                    <Grid item xs={6}>
                        ...
                        <Typography variant="body2" sx={{ fontWeight: 700 }}>{row.TrongSoBaoCao || 0}</Typography>
                    </Grid>
                </Grid>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box>
                        <Typography variant="caption" color="text.secondary" sx={{ display: 'block' }}>{row.DiaChi || 'Chưa cập nhật địa chỉ'}</Typography>
                    </Box>
                    <ActionButtons
                        row={row}
                        canEdit={canEdit}
