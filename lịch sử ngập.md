...
*   **Ràng buộc:** Chỉ cho phép Reviewer gửi nhận xét nếu trạng thái báo cáo đang là **"Đang ngập" (active)**. Nếu đã kết thúc, hệ thống sẽ chặn và không hiển thị cho nhận xét.
