...
| :--- | :--- | :--- | :--- |
| `ai:chat` | `[BUTTON]` | Trợ lý AI | Chat tự do hỗ trợ báo cáo mùa mưa |
| `ai:report` | `[BUTTON]` | Tin nhắn/Báo cáo AI | Tạo tin nhắn báo cáo / BC CT KC |
| `ai:synthesis` | `[BUTTON]` | Tổng hợp AI | Báo cáo tổng hợp |
